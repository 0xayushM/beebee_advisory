    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--background)', color: 'var(--foreground)' }}>
      ...
      <section className="px-6 py-20 md:px-12 lg:px-20">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            ...
            <h1 className="text-6xl md:text-7xl lg:text-8xl leading-none mb-8" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>
              LET'S BUILD<br />TOGETHER
            </h1>
            <p className="text-base max-w-3xl leading-relaxed" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-20">
            <div>
              <form className="space-y-6">
                <div>
                  <label className="block text-sm mb-2 font-bold" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif' }}>
                    FULL NAME *
                  </label>
                  <input
                    type="text"
            ...
            <div className="space-y-8">
              <div className="p-8 rounded-lg" style={{ backgroundColor: 'var(--card-bg)' }}>
                ...
                <h3 className="text-xl mb-2" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>EMAIL US</h3>
                <p className="text-sm mb-4" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>
                  For general inquiries and support
                </p>
                <a href="mailto:info@beebeeadvisory.com" className="text-sm hover:opacity-70" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--primary-gold)' }}>
              ...
              <div className="p-8 rounded-lg" style={{ backgroundColor: 'var(--card-bg)' }}>
                <div className="text-3xl mb-4">📍</div>
                <h3 className="text-xl mb-2" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>LOCATIONS</h3>
                <p className="text-sm mb-4" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>
                  We operate across major markets
                </p>
                <div className="space-y-2 text-sm" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>
                  <p>🇺🇸 United States</p>
                  <p>🇬🇧 United Kingdom</p>
                  <p>🇨🇦 Canada</p>
                </div>
              ...
              <div className="p-8 rounded-lg" style={{ backgroundColor: 'var(--card-bg)' }}>
                <div className="text-3xl mb-4">⏰</div>
                <h3 className="text-xl mb-2" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>BUSINESS HOURS</h3>
                <p className="text-sm mb-4" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>
                  Available to serve you
                </p>
                <div className="space-y-1 text-sm" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>
      ...
      <section className="px-6 py-16 md:px-12 lg:px-20" style={{ backgroundColor: 'var(--section-bg-dark)', color: 'var(--text-primary)' }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base mb-8 leading-relaxed" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>
          ...
          <button className="px-10 py-4 text-sm font-bold hover:opacity-90 transition-opacity" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', backgroundColor: 'var(--primary-gold)', color: '#000' }}>
            SCHEDULE A CALL
          </button>
        </div>
      </section>
      ...
      <footer className="px-6 py-12 md:px-12 lg:px-20" style={{ borderTop: '1px solid var(--border-gray)' }}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', borderTop: '1px solid var(--border-gray)', color: 'var(--text-secondary)' }}>
