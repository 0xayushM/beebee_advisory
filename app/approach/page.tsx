    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--background)', color: 'var(--foreground)' }}>
      ...
      <section className="px-6 py-16 md:px-12 lg:px-20">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 mb-16">
          <div className="p-10 rounded-lg border" style={{ backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-gray)' }}>
            ...
            <p className="text-sm leading-relaxed mb-6" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>
          ...
          <div className="bg-black text-white p-10 rounded-lg relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="mb-6">
                <h4 className="text-sm mb-2 uppercase tracking-wider" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--primary-gold)' }}>
                  SYNTHESIS
                </h4>
                <p className="text-sm leading-relaxed" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: '#ccc' }}>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 mb-16">
          <div className="p-10 rounded-lg border" style={{ backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-gray)' }}>
            <div className="text-6xl mb-6" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>
              03
            </div>
            <h3 className="text-3xl mb-6" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>
          ...
          <div className="p-10 rounded-lg relative overflow-hidden" style={{ backgroundColor: 'var(--primary-gold)', color: '#000' }}>
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm leading-relaxed mb-6" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif' }}>
      ...
      <section className="px-6 py-16 md:px-12 lg:px-20" style={{ backgroundColor: 'var(--card-bg)' }}>
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-base max-w-3xl mb-12 leading-relaxed" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>
      ...
      <section className="px-6 py-20 md:px-12 lg:px-20" style={{ backgroundColor: '#f9eed5' }}>
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center justify-between mb-12">
            <h2 className="text-5xl md:text-6xl" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>
          ...
          <p className="text-base mb-8 max-w-2xl leading-relaxed" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>
