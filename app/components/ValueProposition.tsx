      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="text-black">
            ...
            <p className="text-base leading-relaxed mb-6" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif' }}>
            ...
            <ul className="space-y-3 text-sm" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif' }}>
            ...
            <div className="relative">
              <div className="w-64 h-64 md:w-80 md:h-80 rounded-full bg-white bg-opacity-20 flex items-center justify-center">
                <div className="text-center text-black">
                  ...
                  <p className="text-lg font-bold" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>
