    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--background)', color: 'var(--foreground)' }}>
      ...
      <section className="px-6 py-20 md:px-12 lg:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-base max-w-3xl leading-relaxed mb-8" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>
        ...
        <div className="max-w-7xl mx-auto mb-20">
          <div className="grid md:grid-cols-2 gap-12 mb-12">
            <div>
              ...
              <p className="text-base leading-relaxed mb-6" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>
            ...
            <div className="p-8 rounded-lg" style={{ backgroundColor: 'var(--card-bg-alt)', color: 'var(--text-primary)' }}>
              ...
              <h4 className="text-4xl mb-6" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-6 rounded-lg border" style={{ backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-gray)' }}>
              ...
              <h4 className="text-lg mb-2" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>MONTHLY<br />CLOSE</h4>
            ...
            <div className="p-6 rounded-lg border" style={{ backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-gray)' }}>
              <div className="text-3xl mb-4">💰</div>
              <h4 className="text-lg mb-2" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>CASH FLOW<br />MODELING</h4>
              <p className="text-sm" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>
            ...
            <div className="p-6 rounded-lg border" style={{ backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-gray)' }}>
              <div className="text-3xl mb-4">📈</div>
              <h4 className="text-lg mb-2" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>BOARD<br />REPORTING</h4>
              <p className="text-sm" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>
        ...
        <div className="max-w-7xl mx-auto mb-20">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="p-10 rounded-lg border" style={{ backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-gray)' }}>
              ...
              <h3 className="text-4xl mb-6" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>
                FP&A
              </h3>
              <p className="text-base leading-relaxed mb-8" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-xs" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>FORECAST VARIANCE</p>
                </div>
                <div>
                  <div className="text-3xl mb-2" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400', color: 'var(--primary-gold)' }}>24H</div>
                  <p className="text-xs" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>SCENARIO TURNAROUND</p>
                </div>
              </div>
            </div>
      ...
      <section className="px-6 py-16 md:px-12 lg:px-20" style={{ backgroundColor: 'var(--section-bg-dark)', color: 'var(--text-primary)' }}>
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="text-5xl md:text-6xl mb-8" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>
                FROM LEDGER<br />
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="p-6 rounded-lg" style={{ backgroundColor: '#1a1a1a' }}>
              ...
              <h4 className="text-xl mb-3" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>ALIGNMENT</h4>
              <p className="text-sm" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: '#999' }}>
            ...
            <div className="p-6 rounded-lg" style={{ backgroundColor: '#1a1a1a' }}>
              ...
              <h4 className="text-xl mb-3" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>REFINEMENT</h4>
              <p className="text-sm" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: '#999' }}>
            ...
            <div className="p-6 rounded-lg" style={{ backgroundColor: '#1a1a1a' }}>
              ...
              <h4 className="text-xl mb-3" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>FORESIGHT</h4>
              <p className="text-sm" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: '#999' }}>
            ...
            <div className="p-6 rounded-lg" style={{ backgroundColor: '#1a1a1a' }}>
              ...
              <h4 className="text-xl mb-3" style={{ fontFamily: 'Anton, sans-serif', fontWeight: '400' }}>OPTIMIZATION</h4>
              <p className="text-sm" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: '#999' }}>
      ...
      <section className="px-6 py-20 md:px-12 lg:px-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-base mb-12 max-w-2xl mx-auto leading-relaxed" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', color: 'var(--text-secondary)' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-10 py-4 text-sm text-white hover:opacity-90 transition-opacity" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', backgroundColor: 'var(--primary-gold)' }}>
              BOOK A DISCOVERY CALL
            </button>
            <button className="px-10 py-4 text-sm border transition-colors" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif', borderColor: 'var(--border-color)' }}>
      ...
      <footer className="px-6 py-12 md:px-12 lg:px-20" style={{ backgroundColor: 'var(--card-bg)' }}>
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              <h4 className="text-sm mb-4 uppercase font-bold" style={{ fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif' }}>SERVICES</h4>
